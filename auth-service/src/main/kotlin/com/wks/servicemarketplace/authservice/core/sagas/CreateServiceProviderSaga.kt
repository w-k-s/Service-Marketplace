...
class CreateServiceProviderSaga @Inject constructor(private val eventDao: EventDao,
        ...
        eventDao.connection().use { conn ->
            try {
                ...
                outboxDao.saveMessage(conn, Message(
                        ...
                        destinationRoutingKey = AuthMessaging.RoutingKey.SERVICE_PROVIDER_ACCOUNT_CREATED,
