...
internal class DefaultEmployeeDaoIT {
    ...
    companion object {
        ...
        private val companyServices = Services(Service.ELECTRICAL)
    ...
    fun `GIVEN an employee, WHEN it is saved, THEN it can be retrieved`() {
        dataSource.connection().use {
            ...
            assertThat(savedEmployee.name.firstName).isEqualTo(employeeFirstName)
            assertThat(savedEmployee.name.lastName).isEqualTo(employeeLastName)
