...
public enum ErrorType {
    ...
    UNAUTHORIZED(ErrorType.GENERAL_ERROR_UNAUTHORIZED),
    ...
    private static final int GENERAL_ERROR_UNKNOWN = SERVICE_CODE + CATEGORY_CODE_GENERAL_ERROR;                        // 200000
    ...
    private static final int GENERAL_ERROR_UNAUTHENTICATED = SERVICE_CODE + CATEGORY_CODE_GENERAL_ERROR + 40;           // 200040
    private static final int GENERAL_ERROR_UNAUTHORIZED = SERVICE_CODE + CATEGORY_CODE_GENERAL_ERROR + 42;              // 200042
