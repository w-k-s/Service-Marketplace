...
data class Address private constructor(
    ...
    @field:Column(name = "address_line1")
    val line1: String,
    ...
    @field:Column(name = "address_city")
    val city: String,

    @field:Convert(converter = CountryCodeConverter::class)
    @field:AttributeOverride(name = "code", column = Column(name = "address_country"))
    val country: CountryCode,

    @field:DecimalMin("-90")
    @field:DecimalMax("90")
    @field:Column(name = "address_latitude", precision = 9, scale = 5)
    val latitude: BigDecimal,

    @field:DecimalMin("-180")
    @field:DecimalMax("180")
    @field:Column(name = "address_longitude", precision = 9, scale = 5)
